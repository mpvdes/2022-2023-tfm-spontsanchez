...
```{r}
accidentes <- readr::read_csv('datasets_accidentes/datos_accidentes.csv')
barris <- st_read('shapefiles_bcn/bcn_unitats_administratives/0301040100_Barris_UNITATS_ADM.shp')
carrers_bcn <- st_read('shapefiles_bcn/bcn_carrers/BCN_GrafVial_Trams_ETRS89_SHP.shp')
calles_30 <- st_read('shapefiles_bcn/carrers_30_xarxa_primaria.csv', sep=';')
```
